...
probeersel5<-lmer(Flighttime_min ~ Traject100mLM + Temperature_KMI +  Traject100m*Temperature_KMI + (1|Individualcode), offset=Distance, na.action=na.omit, data=KMIdata)
summary(probeersel5)
```
