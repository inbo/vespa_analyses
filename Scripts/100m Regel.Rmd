...
ggplot(Eigendata_shortind, aes(x=Distance, y=Flighttime_min)) + geom_point(color="dodgerblue2", size=2) + geom_abline(intercept=0, slope=0.01, color="darkorange2", linewidth=1.2) + geom_abline(intercept=1.3534083, slope=0.0064593, color="dodgerblue4", linewidth=1.2)  +  ggtitle("Test rule of thumb | Shortest per individual") + theme(plot.title = element_text(hjust = 0.5, size=17), axis.title=element_text(size=15), axis.text=element_text(size=13))  + xlim(0,2100)+ ylim(0,21) + scale_x_continuous(name="Distance (m)", limits=c(0, 1500, 500)) + scale_y_continuous(name="Flight time (min)", limits=c(0,20,5))
