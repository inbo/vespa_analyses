...
ggplot(Flights_eigendata, aes(x=factor(NestID), y=Distance)) + geom_point(width=0.5, color = "dodgerblue4")+ scale_x_discrete(name ="NestID") + ggtitle("Distances per nest") + theme(plot.title = element_text(hjust = 0.5)) + scale_y_continuous(name="Distance from bait till the nest (m)", breaks=seq(0,2100,500))

ggplot(Flights_eigendata, aes(x=factor(NestID), y=ForagingSpeed)) + geom_point(width=0.5, color = "dodgerblue4")+ scale_x_discrete(name ="NestID") + ggtitle("Foraging speeds per nest") + theme(plot.title = element_text(hjust = 0.5)) + scale_y_continuous(name="Foraging speed (m/s)", breaks=seq(0,11,1))
